...
- (id)expandablePromosheetDelegate { return YTMU(@"YTMUltimateIsEnabled") ? nil : %orig; }
...
- (id)upsellDialogController { return YTMU(@"YTMUltimateIsEnabled") ? nil : %orig; }
...
- (id)offlineButtonPromoController { return YTMU(@"YTMUltimateIsEnabled") ? nil : %orig; }
- (void)executeCommandWrapperPromoRenderer:(id)arg1 firstResponder:(id)arg2 {
    if (!YTMU(@"YTMUltimateIsEnabled")) %orig;
}
- (BOOL)shouldMealbarPromoController:(id)arg1 displayConnectionStatusMealbar:(id)arg2 hasContentDownloaded:(BOOL)arg3 { return YTMU(@"YTMUltimateIsEnabled") ? NO : %orig; }
%end
...
- (id)mealbarPromoController { return YTMU(@"YTMUltimateIsEnabled") ? nil : %orig; }
